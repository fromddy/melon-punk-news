...
const podcastEpisodes: PodcastEpisode[] = [
    ...
    },
    {
        ...
        description:
            '如何通过DeFi理财赚钱',
        youtubeId: 'm-pV5fjikwQ',
        publishedAt: '2025-11-19T17:30:00',
        guestName: 'wongSSH',
        guestBio: ['DeFi 合约工程师', '项目获得了uniswap foundation的grant'],
        highlights: [
            '播客录制时间: 2025年11月7日',
            '00:00   开场白和自我介绍',
            '01:00   DeFi 理财的风险提醒, 本金归零, 黑客攻击等',
            '02:24   DeFi 理财的主流类别: 借贷协议, 添加流动性, pendle',
            '03:50   借贷协议 aave, morpho, coumpound的初步介绍',
            '13:00   如何评估DeFi协议真实的年化率',
            '15:35   除了去中心化交易所(Dex) 和借贷协议之外的 DeFi协议类别: 稳定币, 流动性质押Lido 等',
            '17:44   算法稳定币是DeFi 吗',
            '18:56  流动性质押的收益来源, 流动性质押和restaking的关系',
            '22:43  流动性质押 和 个人质押 的对比',
            '26:24  极端行情对于aave借贷协议参与者的影响',
            '29:34  极端行情对于morpho借贷协议参与者的影响',
            '31:40  借贷协议为什么会爆雷',
            '34:20  借贷协议的借款人相关的讨论，循环贷',
            '44:00  闪电贷',
            '46:20  给去中心化交易所做LP',
            '54:41  pendle 的机制  PT是折价的零利债券, YT代表底层资产的收益率',
            '1:09:02. balancer被盗的连锁反应',
            '1:18:24. AMM创新领域: 抗LVR, 抗MEV, 自动化LP管理,动态费率,AMM 和 借贷协议的结合等',
            '1:23:17  借贷领域的创新: 等待aave v4的发布, 统一的流动性平台, Morpho 搞自己新的策展人金库',
            '1:25:07  如何看待Vitalik强调 low - risk DeFi这件事',
            '1:27:43   DeFi 创业需要花很多精力与大户搞好关系，是否一定程度上会遏制技术创新',
            '1:32:23  想在 DeFi 领域创业的建议',
            '1:35:35  DeFi是否加速了币圈资产出现大幅度波动, 造成了系统性风险',
            '1:40:40  DeFi 理财 和 定投btc / ETH 的对比',
        ],
        guestLinks: [
            { label: 'Guest · Farcaster', url: '' },
            { label: 'Guest · Twitter', url: 'https://x.com/wong_ssh' },
